...
.. mermaid::
   ...
   graph TD
       A[Evaluation Run / Scan Results] --> B[Create Task]
       B --> C{Persona}
       C -->|Business| D[Review Test Results]
       C -->|Product Owner| E[Modify Test Cases]
       D --> F{Agree with Result?}
       F -->|Yes| G[Close Task]
       F -->|No| H[Assign to Product Owner]
       H --> E
       E --> I[Validate Changes]
       I --> J[Undraft Test Case]
       J --> K[Available for Evaluations]
