...
**Task management**
   ...
   * **Hide Noisy Results** - You can now hide fasle positive results while still tracking them with tasks
   * **Prioritise Tasks** - Set the priority of the task based on the importance of the work to be done
